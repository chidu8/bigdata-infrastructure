...
public class Hyperloglog {
	...
	private void addEleToRegisterSet(String element) {
		...
		String binaryHash = new StringBuilder(rBinaryHash).reverse().toString(); // Getting reverse
		...
		registerSet.setRegister( registerIndex,Math.max( numZeroes,registerSet.getRegisterValue(registerIndex) ) );
	}
